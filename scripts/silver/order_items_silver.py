...
def processar_order_items_silver():
    base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
    bronze_path = os.path.join(base_path, 'dados', 'bronze', 'order_items_bronze.parquet')
    silver_path = os.path.join(base_path, 'dados', 'silver', 'order_items_silver.parquet')
    prefixo = "order_item_"
    ...
    print("📄 Schema após remoção do prefixo (order_items):")
